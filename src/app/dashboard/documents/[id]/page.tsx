...
export default async function DocumentDetailPage({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 text-sm">
        <p><span className="font-medium text-zinc-900">File:</span> <span className="text-zinc-700">{document.originalName}</span></p>
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-6">
        <div className="mb-3 flex items-center gap-3">
          <a href={exportHref} className="rounded-lg border border-zinc-300 bg-white px-3.5 py-2 text-sm font-medium text-zinc-800 transition hover:bg-zinc-50">Download</a>
        </div>
        <pre className="max-h-[420px] overflow-auto whitespace-pre-wrap rounded-lg bg-zinc-50 p-4 text-xs text-zinc-700">
