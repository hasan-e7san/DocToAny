...
export default async function Home() {
  ...
  return (
    <div className="flex-1 bg-zinc-100 text-zinc-900">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6 sm:py-10 md:gap-10 md:py-14">
        <section className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-5 sm:p-8 md:p-12">
            ...
            <div>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                {isAuthenticated ? (
                  <Link
                    href="/dashboard"
                    className="rounded-lg bg-zinc-900 px-5 py-2.5 text-center text-sm font-medium text-white transition hover:bg-zinc-800 sm:w-auto"
                  >
                    Open dashboard
                  </Link>
                ) : (
                  <>
                    ...
                    <Link
                      href="/login"
                      className="rounded-lg border border-zinc-300 bg-white px-5 py-2.5 text-center text-sm font-medium text-zinc-800 transition hover:bg-zinc-50 sm:w-auto"
                    >
                      Login
                    </Link>
                  </>
